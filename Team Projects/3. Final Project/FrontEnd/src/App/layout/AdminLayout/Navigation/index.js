...
class Navigation extends Component {
    ...
    // const userContext = useContext(UserContext); <-> static contextType=UserContext; const uContext=this.context;
    ...
    componentDidMount() {
        const uContext=this.context;
        console.log("Ucontext",uContext.user);
        this.setState({isLoggedIn:!!uContext.user});
        this.resize();
